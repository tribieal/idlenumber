...
#euca2 vm05
node = "ssh vm05.xingcloud.com /usr/bin/euca-describe-availability-zones verbose |grep m1.xlarge|awk '{print $4}'"
java2 = commands.getstatusoutput(node)[1]

node = "ssh vm05.xingcloud.com /usr/bin/euca-describe-availability-zones verbose |grep medium|awk '{print $4}'"
...
#sum of euca1.2.3.4
java = int(java1)+int(java2)+int(java3)+int(java4)
java = str(java)
php = int(php1)+int(php2)+int(php3)+int(php4)
php = str(php)
